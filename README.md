...
You can run this app by setting up the following services and adding their environment variables:

1. Run `npm install` to install dependencies.
2. Run `npx convex dev`. It will prompt you to log into [Convex](https://convex.dev) and create a project.
...
6. Run `npm run dev`. Now your frontend and backend should be running and you should be able to log in but not support OpenAI features.
